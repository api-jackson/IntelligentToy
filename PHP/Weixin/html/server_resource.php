...
<body>
    <div id='container'>
        <div id='left-side' >
            <form action='download.php' method='get' class='image'>
                <input type='image'  src='image/song.jpg'  width='300'height='300'>
				<input type='hidden' name='code' value=$code>
				<input type='hidden' name='command' value='download_song'>
                <div>儿歌</div>
            </form>
            <form action='download.php' method='get' class='image'>
                <input type='image' src='image/classic.jpg'  width='300'height='300'>
                <input type='hidden' name='code' value=$code>
                <input type='hidden' name='command' value='download_music'>
                <div>经典名曲</div>
            </form>
        </div>
        <div id='right-side'>
            <form action='download.php' method='get' class='image'>
                ...
                <input type='hidden' name='code' value=$code>
                <input type='hidden' name='command' value='download_story'>
                <div>故事</div>
            </form>
        </div>
    </div>
